...
const products: Product[] = [
  ...
  { id: "camera-agricole-v1",           name: "Caméra Agricole 4G — Version 1",       description: "Vision HD 24/7, solaire, stockage cloud.",            price: 105000,  image: "/c2.png",        category: "camera" },
  ...
  { id: "Sotilma-Mobile",                     name: "Sotilma Mobile",                         description: "Pack complet caméra + vanne tout-en-un.",             price: 975000, image:"https://static.wixstatic.com/media/75ad33_5ae75292849c40308616364b4b782980~mv2.png", category: "pack" },
];
...
const promos = [
  ...
  { label: "POMPE SOTILMA ",    sub: "TOUT-EN-UN",               btn: "Voir les packs",   cat: "pack",   bg: "https://static.wixstatic.com/media/75ad33_5ae75292849c40308616364b4b782980~mv2.png" },
...
const productDetails: Record<string, { longDesc: string; features: string[] }> = {
  ...
  "Sotilma-Mobile":                    { longDesc: "Le Kit Pack  regroupe tout ce dont vous avez besoin pour surveiller et irriguer votre exploitation. Caméra 4G et vanne automatique, le tout alimenté à 100% solaire. Prêt à l'emploi.", features: ["Caméra 4G incluse", "Vanne automatique", "Pilotage complet", "100% solaire", "Installation clé en main", "Surveillance 24/7", "Économie d'eau", "Application mobile incluse", "Garantie 6 mois"] },
};
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      >
        ...
        <div className="px-6 pt-5 pb-4">
          <h2 className="font-bold leading-snug mb-1" style={{ fontSize: "0.85rem", color: TEXT_D }}>
            {product.name}
          </h2>
          <p className="font-black text-sm" style={{ color: BLUE }}>{fmt(product.price)}</p>
        </div>
                    ...
                    <motion.div key={p.id} variants={cardAnim} className="h-full">
                      ...
                      >
                        ...
                        <div className="flex flex-col flex-1 px-3 pt-2.5 pb-3">
                          ...
                          <p className="text-center font-bold mb-2 flex-1 flex items-end justify-center" style={{ fontSize: "0.88rem", color: "#111", lineHeight: 1 }}>
                            {fmt(p.price)}
                          </p>
                          <motion.button
